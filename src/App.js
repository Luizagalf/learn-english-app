...
function App() {
  ...
  const addWord = (id, valueWord, valueTranslation) => {
    setWords([
      ...words,
      { id: id, english: valueWord, russian: valueTranslation }
    ]);
  };
        ...
        <div className={styles.main}>
          <Switch>
            <Route
              ...
              path="/game"
              component={() => (
                <Slider words={words} isLoading={isLoading} error={error} />
              )}
            />
            <Route
              exact
            ...
            <Route
              ...
              path="/allwords"
              component={() => (
                <Wordcards words={words} isLoading={isLoading} error={error} />
              )}
            />
            <Route
              exact
